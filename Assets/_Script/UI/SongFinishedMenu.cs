...
namespace Rhythm.UI
{
    public class SongFinishedMenu : MonoBehaviour
    {
        ...
        [Header("Grade Colors")]
        [SerializeField] private Color sRankColor = new Color(1f, 0.8f, 0f, 1f); // Gold
        [SerializeField] private Color aRankColor = new Color(0f, 1f, 0f, 1f); // Green
        [SerializeField] private Color bRankColor = new Color(0f, 0.5f, 1f, 1f); // Blue
        [SerializeField] private Color cRankColor = new Color(1f, 0.5f, 0f, 1f); // Orange
        [SerializeField] private Color dRankColor = new Color(1f, 0f, 0f, 1f); // Red
